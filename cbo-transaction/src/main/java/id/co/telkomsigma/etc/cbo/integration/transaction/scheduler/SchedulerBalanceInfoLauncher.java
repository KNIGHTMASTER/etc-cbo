 ...
 */
@Component
public class SchedulerBalanceInfoLauncher extends ASchedulerLauncher {

    private static final Logger LOGGER = LoggerFactory.getLogger(SchedulerBalanceInfoLauncher.class);
